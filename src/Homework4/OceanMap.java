...
public class OceanMap {
	...
	public void drawMap(ObservableList<Node> root, int scale) {
		Image ocean = new Image("images//water2.jpg",scale, scale, false, true);
	...
	public void placeIslands(ObservableList<Node> root, int scale) {
		...
		for(int i = 0; i <= 9; i++) {
			...
			if (oceanGrid[randomNum][randomNum2] == 0) {
				...
				island = new Image("file:///Users/michaelhavighorst/git/activeRepository/src/Homework4/islandPic.png",scale, scale, false, true);
